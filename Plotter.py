...
def update(_, data_queue: Queue, img: AxesImage, pos_heatmap: AxesImage, ball_pos_plot: Line2D, processing_region, corner_points_plt, line_plots, ax2):
	frame, heatmap, pos, data_points, time = data_queue.get()
	...
	return img, pos_heatmap, ball_pos_plot, processing_region, corner_points_plt, *line_plots
...
def plot(data_queue, termination_event, target_pos_queue, line_plot_labels, corner_br, corner_bl, corner_tl, corner_tr):
	...
	update_func = partial(update, data_queue=data_queue, img=img, pos_heatmap=pos_heatmap, ball_pos_plot=ball_pos_plot, processing_region=processing_region, corner_points_plt=corner_points_plt, line_plots=line_plots, ax2=ax[1])
