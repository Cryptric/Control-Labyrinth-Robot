...
def align_data(data_x, data_y):
	...
	for i in range(n):
		state_x, ref_x, pred_x, _ = data_x[i]
		state_y, ref_y, pred_y, _ = data_y[i]
...
def main():
	...
	ref_points, actual_points, ref_pred, n, outliers = align_data(recoded_data_x, recoded_data_y)
	...
	heatmap(axs[0])
	plot_axis_deviation_histogram(axs[1], recoded_data_x, "X")
	plot_axis_deviation_histogram(axs[2], recoded_data_y, "Y")
